...
class TestAbstractBaseResource extends AbstractBaseResource<BaseModel, {}, {}, {}, Error> {
    ...
    async create(model: ResourceModelType, typeConfiguration: TypeConfigurationM): Promise<CreateResponseData> {
        return Promise.resolve({});
    }

    async delete(model: ResourceModelType, typeConfiguration: TypeConfigurationM): Promise<void> {
        return Promise.resolve(undefined);
    }

    async get(model: ResourceModelType, typeConfiguration: TypeConfigurationM): Promise<GetResponseData> {
        return Promise.resolve({});
    }

    async list(model: ResourceModelType, typeConfiguration: TypeConfigurationM): Promise<ResourceModelType[]> {
        return Promise.resolve([]);
    }
    ...
    async update(model: ResourceModelType, typeConfiguration: TypeConfigurationM): Promise<UpdateResponseData> {
        return Promise.resolve({});
    }
