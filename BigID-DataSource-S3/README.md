...
1. Write the JSON schema describing your resource, [bigid-datasource-s3.json](./bigid-datasource-s3.json)
2. Implement your resource handlers in [handlers.ts](./bigid-datasource-s3/handlers.ts)

> Don't modify [models.ts](./bigid-datasource-s3/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
